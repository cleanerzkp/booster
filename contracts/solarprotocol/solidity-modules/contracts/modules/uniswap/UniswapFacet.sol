...
contract UniswapFacet is IUniswapFacet {
    ...
    function uniswapGetFactory() external view returns (address factory) {
        factory = address(LibUniswap.getFactory());
    }
    ...
    function uniswapGetRouter() external view returns (address router) {
        router = address(LibUniswap.getRouter());
    }
    ...
    {
        intermediateWallet = LibUniswap.getIntermediateWallet();
    }
}
